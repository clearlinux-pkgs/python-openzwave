...
%prep
%setup -q -n python-openzwave-0.1.8
cd %{_builddir}
unzip -q %{_sourcedir}/open-zwave-master-0.4.9.zip
cd %{_builddir}/python-openzwave-0.1.8
mkdir -p openzwave-embed/open-zwave-master
cp -r %{_builddir}/open-zwave-master/* %{_builddir}/python-openzwave-0.1.8/openzwave-embed/open-zwave-master
...
cp %{_builddir}/python-openzwave-0.1.8/COPYRIGHT.txt %{buildroot}/usr/share/package-licenses/python-openzwave/f0cb7c2c2db59bd17a620fd5070dffe7aa8acdb6
cp %{_builddir}/python-openzwave-0.1.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/python-openzwave/f0cb7c2c2db59bd17a620fd5070dffe7aa8acdb6
cp %{_builddir}/python-openzwave-0.1.8/debian/copyright %{buildroot}/usr/share/package-licenses/python-openzwave/215fd18143ce0317e4e689997e898cfbc9b68196
