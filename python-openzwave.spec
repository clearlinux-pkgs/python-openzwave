...
Version  : 0.1.9
Release  : 17
URL      : https://github.com/home-assistant/python-openzwave/archive/v0.1.9/python-openzwave-0.1.9.tar.gz
Source0  : https://github.com/home-assistant/python-openzwave/archive/v0.1.9/python-openzwave-0.1.9.tar.gz
...
%prep
%setup -q -n python-openzwave-0.1.9
cd %{_builddir}
unzip -q %{_sourcedir}/open-zwave-master-0.4.9.zip
cd %{_builddir}/python-openzwave-0.1.9
mkdir -p openzwave-embed/open-zwave-master
cp -r %{_builddir}/open-zwave-master/* %{_builddir}/python-openzwave-0.1.9/openzwave-embed/open-zwave-master
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584377144
...
cp %{_builddir}/python-openzwave-0.1.9/COPYRIGHT.txt %{buildroot}/usr/share/package-licenses/python-openzwave/f0cb7c2c2db59bd17a620fd5070dffe7aa8acdb6
cp %{_builddir}/python-openzwave-0.1.9/LICENSE.txt %{buildroot}/usr/share/package-licenses/python-openzwave/f0cb7c2c2db59bd17a620fd5070dffe7aa8acdb6
cp %{_builddir}/python-openzwave-0.1.9/debian/copyright %{buildroot}/usr/share/package-licenses/python-openzwave/215fd18143ce0317e4e689997e898cfbc9b68196
